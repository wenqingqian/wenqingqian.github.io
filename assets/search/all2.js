    ...
    var data = {
        "resource": {
            ...
            "tags": [{
                ...
                "vtp_instanceDestinationId": "G-6L3G54N42E",
                "tag_id": 3
            }, {
...
*/
    ...
    aa = fb.prototype;
    aa.set = function(a, b) {
        this.C || wa.prototype.set.call(this, a, b)
    }
    ;
    aa.Jh = function(a, b) {
        this.C || wa.prototype.Jh.call(this, a, b)
    }
    ;
    aa.remove = function(a) {
        this.C || wa.prototype.remove.call(this, a)
    }
    ;
    aa.Bb = function() {
        this.C = !0
 ...
 jQuery (c) 2005, 2012 jQuery Foundation, Inc. jquery.org/license. */
    ...
    ;
    aa.Pb = function() {
        for (var a = gb(this.B, 1), b = 0; b < this.h.length; b++)
            a.push(b + "");
        return new qb(a)
    }
    ;
...
*/
    ...
    var of = [], pf = [], qf = [], rf = [], sf = [], tf = {}, uf, vf, wf = function(a) {
        ...
        var e = tf[c], f = b && 2 === b.type && d.reportMacroDiscrepancy && e && -1 !== zf.indexOf(c), g = {}, k = {}, m;
        for (m in a)
        ...
        if (Ea(a)) {
            ...
            case "template":
                ...
                return vf && p ? vf.Tk(d) : d.join("");
            case "escape":
                d = Cf(a[1], b, c);
                if (vf && Ea(a[1]) && "macro" === a[1][0] && vf.Il(a))
                    return vf.gm(d);
                d = String(d);
    ...
    var Of = {
        Qk: function(a, b) {
            b[Pe.Sh] && "string" === typeof a && (a = 1 == b[Pe.Sh] ? a.toLowerCase() : a.toUpperCase());
            b.hasOwnProperty(Pe.Uh) && null === a && (a = b[Pe.Uh]);
            b.hasOwnProperty(Pe.Wh) && void 0 === a && (a = b[Pe.Wh]);
            b.hasOwnProperty(Pe.Vh) && !0 === a && (a = b[Pe.Vh]);
            b.hasOwnProperty(Pe.Th) && !1 === a && (a = b[Pe.Th]);
            return a
        }
    };
    var Pf = function() {
      ...
      , K = function(a, b, c) {
        for (var d = 0; d < b.length; d++) {
            ...
            if (null == m) {
                ...
                if (n != k)
                    throw Error("Error in " + a + ". Argument " + f + " has type " + (Jg[n] || n) + ", which does not match required type " + (Jg[k] || k) + ".");
            }
        }
    };
    function Kg(a) {
      ...
      , Rg = function(a, b) {
        ...
        for (d in b)
            if (b.hasOwnProperty(d)) {
                var e = b[d];
                Ca(e) ? c.set(d, Qg(a + "_" + d, e)) : lb(e) ? c.set(d, Rg(a + "_" + d, e)) : (Da(e) || h(e) || "boolean" === typeof e) && c.set(d, e)
            }
        c.Bb();
        return c
    };
    ...
    var Bh = function(a) {
        return null == a ? "" : h(a) ? Qa(String(a)) : "e0"
    }
      , Dh = function(a) {
        return a.replace(Ch, "")
    }
        ...
        Vh(a, function(c) {
            for (var d = ["tv.1"], e = 0, f = 0; f < c.length; ++f) {
                var g = c[f].name
                  ...
                  , m = c[f].index
                  , n = Sh[g];
                n && k && (-1 === Lh.indexOf(g) || /^e\d+$/.test(k) || Qh.test(k) || Oh.test(k)) && (void 0 !== m && (n += m),
                d.push(n + "." + k),
                e++)
            }
    ...
    Yh[N.g.ne] = 1,
    Yh));
    Object.freeze([N.g.ra, N.g.Ea, N.g.xb, N.g.Ia, N.g.lf, N.g.za, N.g.df, N.g.ii]);
    var $h = {}
      , ai = Object.freeze(($h[N.g.Xh] = 1,
    $h[N.g.Yh] = 1,
    $h[N.g.Zh] = 1,
    $h[N.g.ai] = 1,
    $h[N.g.bi] = 1,
    ...
    bi[N.g.eg] = 1,
    bi))
      , di = Object.freeze([N.g.fa, N.g.qb, N.g.rb, N.g.Sc, N.g.Ob])
      , ei = Object.freeze([].concat(di))
      , fi = Object.freeze([N.g.Ha, N.g.Hd, N.g.Xc, N.g.nf, N.g.Dd])
    ...
    ni.me = Number("0") || 0;
    ni.da = "dataLayer";
    ni.Rj = "ChAI8NTpqAYQr/T8xsfozeN5EiUAoh0/BRz/1v06tDBpsYEqsg8TnN3uYxRNAqULzzQ11CxSfvB7GgKZ9Q\x3d\x3d";
    var qi = {
        __cl: 1,
        __ecl: 1,
        __ehl: 1,
    ...
    var Ai, Bi = !1;
    Ai = Bi;
    ni.Ve = "www.googletagmanager.com";
    var Ci = "" + ni.Ve + (ui ? "/gtag/js" : "/gtm.js")
      , Di = null
      , Ei = null
      , Fi = {}
      , Gi = {}
    ...
    P[70] = !0;
    a: {
        for (var fj = void 0, gj = void 0, hj = 0; fj === gj; )
            if (fj = Math.floor(2 * Math.random()),
            gj = Math.floor(2 * Math.random()),
            hj++,
            20 < hj)
                break a;
        fj ? P[71] = !0 : P[72] = !0
    }
    Q(72) ? lf[6] = !0 : Q(71) && (lf[5] = !0);
    P[66] = !0;
    P[73] = !0;
    P[74] = !0;
    P[75] = !0;
    ...
    var jj;
    try {
        jj = JSON.parse(xb("eyIwIjoiSEsiLCIxIjoiIiwiMiI6ZmFsc2UsIjMiOiJnb29nbGUuY29tLmhrIiwiNCI6IiIsIjUiOnRydWUsIjYiOmZhbHNlLCI3IjoiYWRfc3RvcmFnZXxhbmFseXRpY3Nfc3RvcmFnZXxhZF91c2VyX2RhdGF8YWRfcGVyc29uYWxpemF0aW9uIn0"))
    } catch (a) {
        M(123),
        ij(2),
        jj = {}
    ...
    Bj.prototype.default = function(a, b, c, d, e, f) {
        ...
        zb("TAGGING", 19);
        void 0 == b ? zb("TAGGING", 18) : Cj(this, a, "granted" === b, c, d, e, f)
    }
    ;
    Bj.prototype.waitForUpdate = function(a, b) {
        for (var c = 0; c < a.length; c++)
            Cj(this, a[c], void 0, void 0, "", "", b)
    }
    ;
        ...
        if (Dj(p, n, e, f)) {
            ...
            q && z.setTimeout(function() {
                if (k[b] === r && r.quiet) {
                    ...
                    if (mf(4))
                        for (var u in wj)
                            wj.hasOwnProperty(u) && wj[u] === b && t.push(u);
    ...
    aa.update = function(a, b) {
        ...
        if (void 0 != b) {
            ...
            if (mf(4))
                for (var k in wj)
                    wj.hasOwnProperty(k) && wj[k] === a && g.push(k);
            if (e.quiet) {
                e.quiet = !1;
    ...
    var Ej = function(a, b) {
        for (var c = 0; c < a.h.length; ++c) {
            var d = a.h[c];
            Ea(d.consentTypes) && -1 !== d.consentTypes.indexOf(b) && (d.wj = !0)
        }
    };
    ...
    function Pj() {}
    function Qj() {}
    ;var Rj = [N.g.I, N.g.R, N.g.M, N.g.nb]
      , Sj = function(a) {
      ...
      , Wj = function(a) {
        ...
        ++d.fd)
            a.hasOwnProperty(N.g.Yf) && l(mi, function(e) {
                return function(f) {
                    Fj(xj, f, a[N.g.Yf], c[e.fd], kj(), lj()) && (yj = !0)
                }
            }(d)),
            l(a, function(e) {
                return function(f, g) {
                    f !== N.g.Ra && f !== N.g.Yf && Fj(xj, f, g, c[e.fd], kj(), lj()) && (yj = !0)
                }
            }(d))
    }
      , S = function(a) {
    ...
    var kk = function() {
      ...
      , sk = function() {
        ...
        if (a) {
            var b = dk();
            if (b.siloed) {
                for (var c = [], d = ik(), e = lk(), f = {}, g = 0; g < b.siloed.length; f = {
                    te: f.te
                },
                g++)
                    f.te = b.siloed[g],
                    !hk && Ga(f.te.isDestination ? e : d, function(k) {
                        return function(m) {
                            return m === k.te.ctid
                        }
                    }(f)) ? hk = !0 : c.push(f.te);
    ...
    function tk() {
        var a = dk();
        if (a.pending) {
            for (var b, c = [], d = !1, e = kk(), f = mk(), g = {}, k = 0; k < a.pending.length; g = {
                ld: g.ld
            },
            k++)
                g.ld = a.pending[k],
    ...
    var uk = function() {
        for (var a = dk(), b = kk(), c = 0; c < b.length; c++) {
            var d = a.container[b[c]];
            d ? (d.state = 2,
            d.containers = kk(),
            d.destinations = mk()) : a.container[b[c]] = {
                state: 2,
                containers: kk(),
                destinations: mk()
            }
        }
        for (var e = mk(), f = 0; f < e.length; f++) {
            var g = a.destination[e[f]];
            g && 0 === g.state && M(93);
            g ? (g.state = 2,
            g.containers = kk(),
            g.destinations = mk()) : a.destination[e[f]] = {
                state: 2,
                containers: kk(),
                destinations: mk()
            }
    ...
    var Ik = Fk
      , Jk = "https://www.googletagmanager.com/a?id=" + Sf.ctid
      , Kk = void 0
      , Lk = {}
      , Mk = void 0
      , Nk = new function() {
    ...
    function Pk(a, b) {
        ...
        if (void 0 === c)
            if (b)
                ...
                return "";
        for (var d = [Jk], e = 0; e < Ck.length; e++) {
            var f = Ck[e]({
                eventId: c,
                Xb: !!a,
                Cj: function() {
    ...
    function Qk() {
        Mk && (z.clearTimeout(Mk),
        Mk = void 0);
        if (void 0 !== Kk && Rk) {
            var a;
            (a = Lk[Kk]) || (a = Nk.h < Nk.B ? !1 : 1E3 > Sa() - Nk.C[Nk.h % Nk.B]);
            if (a || 0 >= Ok--)
                M(1),
                Lk[Kk] = !0;
            else {
    ...
    function Vk() {
        return ["&v=3&t=t", "&pid=" + Tk].join("")
    }
    ;var Wk = function(a, b, c, d, e, f, g, k, m, n, p, q) {
        this.eventId = a;
        this.priorityId = b;
        this.h = c;
        this.K = d;
            ...
            if ("array" === d) {
                ...
                for (var f in c)
                    if (!b.hasOwnProperty(f))
                        return !0;
                for (var g in b)
                    if (!c.hasOwnProperty(g) || Xk(a, b[g], c[g]))
                        return !0
            }
        } catch (k) {
            M(72)
      ...
      , ll = function(a) {
        return new Wk(a.Og,a.vk,a.F,a.fe,a.h,a.K,a.B,a.ee,a.C,a.ud,a.Yb,a.W)
    };
    function ml(a, b) {
        if ("" === a)
            return b;
    ...
    ql() || Yb("Macintosh");
    ql() || Yb("Windows");
    (ql() ? "Linux" === Vb.platform : Yb("Linux")) || ql() || Yb("CrOS");
    var tl = sa.navigator || null;
    tl && (tl.appVersion || "").indexOf("X11");
    ql() || Yb("Android");
    rl();
    Yb("iPad");
    Yb("iPod");
    ...
    var ul = function(a, b, c, d) {
      ...
      , xl = /[?&]($|#)/
      , yl = function(a, b, c) {
        for (var d, e = a.search(vl), f = 0, g, k = []; 0 <= (g = ul(a, f, b, e)); )
            k.push(a.substring(f, g)),
            f = Math.min(a.indexOf("&", g) + 1 || e, e);
        k.push(a.slice(f));
        d = k.join("").replace(xl, "$1");
    ...
    var Dl = function() {
        ...
        return a ? a[a.length - 1] == z.location.origin ? 1 : 2 : zl(z.top) ? 1 : 2
    }
      , Cl = function(a, b) {
    ...
    var Gl = function(a) {
      ...
      , Fl = function(a, b) {
        ...
        if (c.fetch) {
            ...
            El(c, a, void 0 === b ? !1 : b, void 0 === d ? !1 : d)
    };
    var Hl = function() {};
    var Il = function(a) {
      ...
      , Jl = function(a, b) {
        ...
        var d;
        this.F = null != (d = b.mn) ? d : !1;
        this.C = null
    };
    ra(Jl, Hl);
    var Ll = function(a) {
        return "function" === typeof a.B.__tcfapi || null != Kl(a)
    };
    Jl.prototype.addEventListener = function(a) {
        var b = this
          , c = {
    ...
    ;
    Jl.prototype.removeEventListener = function(a) {
    ...
    var Ol = function(a, b, c) {
        ...
        if (0 === k)
            if (a.purpose && a.vendor) {
                ...
                m = n && "1" === b && a.purposeOneTreatment && "CH" === a.publisherCC ? !0 : n && Nl(a.purpose.consents, b)
            } else
                m = !0;
        else
            m = 1 === k ? a.purpose && a.vendor ? Nl(a.purpose.legitimateInterests, b) && Nl(a.vendor.legitimateInterests, void 0 === d ? "755" : d) : !0 : !0;
        return m
    }
      , Nl = function(a, b) {
        return !(!a || !a[b])
      ...
      , Ql = function(a) {
        if (!1 === a.gdprApplies)
            return !0;
        void 0 === a.internalErrorState && (a.internalErrorState = Il(a));
        return "error" === a.cmpStatus || 0 !== a.internalErrorState ? a.internalBlockOnErrors ? (Gl({
    ...
    var Ul = function() {
      ...
      , $l = function() {
        ...
        if ((Wl() || Q(78)) && !a.active && Ll(b)) {
            ...
            Xl(),
            Q(78) && ak([N.g.M]),
            a.tcString = "tcunavailable") : Q(78) && ak([N.g.I, N.g.nb, N.g.M]);
            try {
                b.addEventListener(function(c) {
                    if (0 !== c.internalErrorState)
                        ...
                        if (!1 === c.gdprApplies) {
                            var e = {}, f;
                            for (f in Rl)
                                Rl.hasOwnProperty(f) && (e[f] = !0);
                            d = e;
                            b.removeEventListener(c)
                        } else if ("tcloaded" === c.eventStatus || "useractioncomplete" === c.eventStatus || "cmpuishown" === c.eventStatus) {
                            var g = {}, k;
                            for (k in Rl)
                                if (Rl.hasOwnProperty(k))
                                    if ("1" === k) {
                                        var m, n = c, p = !0;
                                        p = void 0 === p ? !1 : p;
                                        m = Ql(n) ? !1 === n.gdprApplies || "tcunavailable" === n.tcString || void 0 === n.gdprApplies && !p || "string" !== typeof n.tcString || !n.tcString.length ? !0 : Ol(n, "1", 0) : !1;
                                        g["1"] = m
                                    } else
                                        g[k] = Ol(c, k, Rl[k]);
                            d = g
    ...
    var Wl = function() {
      ...
      , Vl = function() {
        var a = Wl();
        if (Q(78)) {
            var b = Tl().enableAdvertiserConsentMode;
            return !a && !b
        }
        return !a
    };
    function Zl(a) {
        var b = {}
          , c = (b[N.g.I] = a.Vb["1"] ? "granted" : "denied",
        b);
        Q(78) && (c[N.g.nb] = a.Vb["3"] && a.Vb["4"] ? "granted" : "denied",
        "number" === typeof a.tcfPolicyVersion && 4 <= a.tcfPolicyVersion && (c[N.g.M] = a.Vb["1"] && a.Vb["7"] ? "granted" : "denied"));
        Uj(c, {
            eventId: 0
        }, {
    ...
    var am = function() {
      ...
      , cm = function(a) {
        if (!Rl.hasOwnProperty(String(a)))
            return !0;
        var b = Tl();
        return b.active && b.Vb ? !!b.Vb[String(a)] : !0
    };
    var dm = [N.g.I, N.g.R]
      , em = [N.g.I, N.g.R, N.g.M, N.g.nb]
      , fm = {}
      , gm = (fm[N.g.I] = 1,
    fm[N.g.R] = 2,
    fm);
    ...
    var im = function(a) {
      ...
      , jm = function() {
        var a = {}, b;
        for (b in gm)
            if (gm.hasOwnProperty(b)) {
                var c = gm[b], d, e = b, f = Aj();
                f.accessedAny = !0;
                d = f.getConsentState(e);
                a[c] = d
            }
        var g = Q(48) && dm.every(Gj)
          , k = Q(43);
        return g || k ? Oe(a, 1) : Oe(a, 0)
    }
      , km = {}
      , lm = (km[N.g.I] = 0,
    km[N.g.R] = 1,
    ...
    var nm = function(a) {
        if (Q(45)) {
            for (var b = "1", c = 0; c < em.length; c++) {
                var d = b, e, f = em[c], g = wj[f];
                e = void 0 === g ? 0 : lm.hasOwnProperty(g) ? 12 | lm[g] : 8;
                var k = Aj();
                k.accessedAny = !0;
                var m = k.entries[f] || {};
                e = e << 2 | mm(m.implicit);
                b = d + ("" + "0123456789abcdefghijklmnopqrstuvwxyzABCDEFGHIJKLMNOPQRSTUVWXYZ-_"[e] + "0123456789abcdefghijklmnopqrstuvwxyzABCDEFGHIJKLMNOPQRSTUVWXYZ-_"[mm(m.declare) << 4 | mm(m.default) << 2 | mm(m.update)])
            }
            void 0 !== a && (b += hm(a));
            return b
        }
        for (var n = "G1", p = 0; p < dm.length; p++)
            switch (Hj(dm[p])) {
            case 3:
                n += "1";
                break;
      ...
      , om = function() {
        ...
        if (b && d)
            for (var f in xj)
                xj.hasOwnProperty(f) && xj[f].enabled && c.hasOwnProperty(f) && c[f].enabled && e.push(f);
        else {
            var g = b ? xj : c, k;
            for (k in g)
    ...
    var qm = function() {
      ...
      , rm = function() {
        return pm() || Aj().usedSetCps || !S(N.g.M)
    }
      , sm = function() {
        var a = "0", b = "0", c;
        var d = Tl();
        c = d.active && Q(78) ? d.cmpId : void 0;
        ...
        var e = "0", f;
        var g = Tl();
        f = g.active && Q(78) ? g.tcfPolicyVersion : void 0;
    ...
    ;var ym = function(a, b, c, d) {
        return wm(d) ? um(a, String(b || xm()), c) : []
    }
    ...
    var Gm = function(a, b, c, d) {
        ...
        g = f(g, c.flags);
        d && d(a, k);
        return Fm(n, c.path) ? 1 : Cm(g, a, b, c.Eb) ? 0 : 1
    }
      , Hm = function(a, b, c) {
        null == c.path && (c.path = "/");
    ...
    var Dm = function(a) {
      ...
      , Im = /^(www\.)?google(\.com?)?(\.[a-z]{2})?$/
      , Sm = /(^|\.)doubleclick\.net$/i
      , Fm = function(a, b) {
        return Sm.test(window.document.location.hostname) || "/" === b && Im.test(a)
    }
      , xm = function() {
      ...
      , Em = function() {
        ...
        Sm.test(e) || Im.test(e) || a.push("none");
        return a
    }
      , wm = function(a) {
    ...
    var Tm = function(a) {
        ...
        return a ? String(b ^ tm(a) & 2147483647) : String(b)
    }
      , Um = function(a) {
        return [Tm(a), Math.round(Sa() / 1E3)].join(".")
    }
    ...
    var Zm = function() {
        oi.dedupe_gclid || (oi.dedupe_gclid = "" + Um());
    ...
    var an = {
      ...
      , bn = function(a) {
        ...
        yi ? c.vh = 1 : $m() ? c.vh = 2 : c.vh = 3;
        var d;
        var e = c.Pf
          , f = c.vh;
        void 0 === e ? d = "" : (f || (f = 0),
        d = "" + Hg(1, 1) + "0123456789abcdefghijklmnopqrstuvwxyzABCDEFGHIJKLMNOPQRSTUVWXYZ-_"[e << 2 | f]);
        var g = c.ln, k = 4 + d + (g ? "" + Hg(2, 1) + "0123456789abcdefghijklmnopqrstuvwxyzABCDEFGHIJKLMNOPQRSTUVWXYZ-_"[g] : ""), m, n = c.om;
        ...
        if (t && a) {
            ...
            if ("GTM" !== v && "OPT" !== v)
                ...
                var w = u[1];
                r = "" + Hg(5, 3) + "0123456789abcdefghijklmnopqrstuvwxyzABCDEFGHIJKLMNOPQRSTUVWXYZ-_"[1 + w.length] + (c.Sl || 0) + w
            }
        } else
            r = "";
        return k + m + p + r
    ...
    bc();
    !Yb("Safari") || bc() || (Zb() ? 0 : Yb("Coast")) || $b() || (Zb() ? 0 : Yb("Edge")) || (Zb() ? Xb("Microsoft Edge") : Yb("Edg/")) || (Zb() ? Xb("Opera") : Yb("OPR")) || ac() || Yb("Silk") || Yb("Android") || sl();
    var fn = {}
      , gn = null
      , hn = function(a) {
        for (var b = [], c = 0, d = 0; d < a.length; d++) {
        ...
        for (var r = fn[f], t = Array(Math.floor(b.length / 3)), u = r[64] || "", v = 0, w = 0; v < b.length - 2; v += 3) {
            var x = b[v]
              , y = b[v + 1]
              , A = b[v + 2]
              , C = r[x >> 2]
    ...
    var un = /:[0-9]+$/
      ...
      , zn = function(a, b, c, d, e) {
        ...
        if ("protocol" === b || "port" === b)
            a.protocol = xn(a.protocol) || xn(z.location.protocol);
        "port" === b ? a.port = String(Number(a.hostname ? a.port : z.location.port) || ("http" === a.protocol ? 80 : "https" === a.protocol ? 443 : "")) : "host" === b && (a.hostname = (a.hostname || z.location.hostname).replace(un, "").toLowerCase());
        return yn(a, b, c, d, e)
    }
      , yn = function(a, b, c, d, e) {
        var f, g = xn(a.protocol);
        b && (b = String(b).toLowerCase());
        switch (b) {
        ...
        case "protocol":
            ...
            break;
        case "host":
            f = a.hostname.replace(un, "").toLowerCase();
            if (c) {
                var k = /^www\d*\./.exec(f);
      ...
      , Dn = function(a) {
        var b = Bn(z.location.href)
          , c = zn(b, "host", !1);
        if (c && c.match(vn)) {
            var d = zn(b, "path").split(a + "=");
            if (1 < d.length)
    ...
    var Jn = function() {
      ...
      , Kn = function(a, b, c, d, e) {
        ...
        In().decorators.push(f)
    }
      , Ln = function(a, b, c) {
        for (var d = In().decorators, e = {}, f = 0; f < d.length; ++f) {
            var g = d[f], k;
            if (k = !c || g.forms)
                a: {
                    var m = g.domains
    ...
    function Yn(a, b) {
        function c(n, p, q) {
            if (Object.keys(n).length) {
                ...
                var w = t.join("*");
                r = ["1", Qn(w), w].join("*");
                d ? (mf(13) || mf(11) || !p) && Zn("_gl", r, a, p, q) : $n("_gl", r, a, p, q)
            }
        }
    ...
    function ao(a, b, c) {
        ...
        "string" == typeof c && Xn(a, b, c)
    }
    function $n(a, b, c, d, e) {
        if (c.href) {
            var f = Xn(a, b, c.href, void 0 === d ? !1 : d, void 0 === e ? !1 : e);
            ic.test(f) && (c.href = f)
        }
    }
    ...
    function Gn(a) {
        try {
            ...
            if (e) {
                var f = e.protocol;
                "http:" !== f && "https:" !== f || Yn(e, e.hostname)
            }
        } catch (g) {}
    }
    function Hn(a) {
    ...
    var bo = function(a, b, c, d) {
        Jn();
        Kn(a, b, "fragment" === c ? 2 : 1, !!d, !1)
    }
      , co = function(a, b) {
        Jn();
        Kn(a, [yn(z.location, "host", !0)], b, !0, !0)
    }
      , eo = function() {
        var a = B.location.hostname
          , b = Nn.exec(B.referrer);
        if (!b)
            return !1;
        var c = b[2]
          , d = b[1]
        ...
        var k = a.replace(On, ""), m = e.replace(On, ""), n;
        if (!(n = k === m)) {
            var p = "." + m;
      ...
      , no = function(a, b) {
        ...
        if (!ho[c])
            if (ko(c, a.path, a.domain)) {
                ...
                lo(a, d ? d.id : void 0, d ? d.uh : void 0)
            } else {
                var e = Dn("auiddc");
                if (e)
                    zb("TAGGING", 17),
    ...
    function oo(a, b) {
        var c = b.split(".");
        5 === c.length ? (ho[a] = c.slice(0, 2).join("."),
        io[a] = {
            id: c.slice(2, 4).join("."),
            uh: Number(c[4]) || 0
        }) : 3 === c.length ? io[a] = {
    ...
    function ro(a, b, c, d, e) {
        ...
        var f = function() {
            var g = {}
              , k = Xm(a, e.path, e.domain, go, "ad_storage");
            k && (g[a] = k);
            return g
        };
        po(function() {
    ...
    ;var uo = /^\w+$/
      ...
      , yo = function(a, b) {
        Ij("ad_storage") ? xo() ? a() : Oj(a, "ad_storage") : b ? zb("TAGGING", 3) : Nj(function() {
            yo(a, !0)
        }, ["ad_storage"])
    }
      , Ao = function(a) {
      ...
      , zo = function(a) {
        ...
        if (!vm(z) || !B.cookie)
            return b;
        var c = ym(a, B.cookie, void 0, "ad_storage");
        if (!c || 0 == c.length)
            return b;
    ...
    var Go = function() {
        var a = Bn(z.location.href)
          , b = zn(a, "query", !1, void 0, "gclid")
          , c = zn(a, "query", !1, void 0, "gclsrc")
          , d = zn(a, "query", !1, void 0, "wbraid")
          , e = zn(a, "query", !1, void 0, "dclid");
        if (!b || !c || !d) {
    ...
    var Lo = function(a, b) {
        var c = Vn(!0);
        yo(function() {
            for (var d = Eo(b.prefix), e = 0; e < a.length; ++e) {
                var f = a[e];
                if (void 0 !== wo[f]) {
                    var g = Jo(f, d)
                      , k = c[g];
                    if (k) {
                        var m = Math.min(Ko(k), Sa()), n;
                        b: {
                            var p = m;
                            if (vm(z))
                                for (var q = ym(g, B.cookie, void 0, "ad_storage"), r = 0; r < q.length; ++r)
                                    if (Ko(q[r]) > p) {
                                        n = !0;
                                        break b
                                    }
      ...
      , Ko = function(a) {
        return 0 !== Mo(a.split(".")).length ? 1E3 * (Number(a.split(".")[1]) || 0) : 0
    };
    function Bo(a) {
        var b = Mo(a.split("."));
    ...
    var No = function(a, b, c, d, e) {
            ...
            var f = Eo(e)
              , g = function() {
                for (var k = {}, m = 0; m < a.length; ++m) {
                    var n = Jo(a[m], f);
                    if (n) {
                        var p = ym(n, B.cookie, void 0, "ad_storage");
      ...
      , Oo = function(a, b) {
        if (vm(z)) {
            for (var c = Eo(b.prefix), d = {}, e = 0; e < a.length; e++)
                wo[a[e]] && (d[a[e]] = wo[a[e]]);
            yo(function() {
                l(d, function(f, g) {
                    var k = ym(c + g, B.cookie, void 0, "ad_storage");
                    k.sort(function(t, u) {
                        return Ko(u) - Ko(t)
                    });
                    if (k.length) {
                        var m = k[0], n = Ko(m), p = 0 !== Mo(m.split(".")).length ? m.split(".").slice(3) : [], q = {}, r;
                        r = 0 !== Mo(m.split(".")).length ? m.split(".")[2] : void 0;
                        q[f] = [r];
                        Ho(q, !0, b, n, p)
                    }
                })
    ...
    var Qo = function(a) {
      ...
      , Ro = function(a) {
        if (!mf(11))
            return null;
        var b = Vn(!0).gad_source;
        if (null != b)
            return b;
        if (mf(12)) {
            var c = Bn(z.location.href);
            b = zn(c, "query", !1, void 0, "gad_source");
            if (null != b)
                return b;
            var d = Go();
            if (Po(d, a))
    ...
    var Wo = function(a) {
        var b = Math.max(Uo("aw", a), Vo(xo() ? to() : {}));
        return Math.max(Uo("gb", a), Vo(xo() ? to("_gac_gb", !0) : {})) > b
    };
    var ap = /[A-Z]+/
      , bp = /\s/
      , cp = function(a, b) {
    ...
    vp.prototype.copyToHitData = function(a, b, c) {
        var d = V(this.s, a);
        void 0 === d && (d = b);
        if (void 0 !== d && void 0 !== c && h(d) && Q(88))
            try {
                d = c(d)
            } catch (e) {}
        void 0 !== d && (this.h[a] = d)
    ...
    ;var Xp = /^(www\.)?google(\.com?)?(\.[a-z]{2}t?)?$/
      ...
      , $p = function(a) {
        a || (a = Zp());
        return a.Im ? !1 : a.zl || a.Al || a.Bl || a.kh || a.Ef || a.jl || a.ql ? !0 : !1
    }
      , Zp = function() {
        var a = {}
          , b = Vn(!0);
        ...
        var d = Bn(z.location.href)
          , e = zn(d, "query", !1, void 0, "gad");
        a.kh = void 0 !== e;
        if (!a.kh) {
        ...
        a.Ef = void 0;
        if (Q(104)) {
            var k = zn(d, "query", !1, void 0, "gad_source");
            a.Ef = k;
            if (void 0 === a.Ef) {
        ...
        var p = B.referrer ? zn(Bn(B.referrer), "host") : "";
        a.ql = Xp.test(p);
        a.jl = Yp.test(p);
        return a
    };
      ...
      , xq = function() {
        ...
        for (var c = b.querySelectorAll("*"), d = 0; d < c.length && 1E4 > d; d++) {
            ...
            if (!(0 <= uq.indexOf(e.tagName.toUpperCase())) && e.children instanceof HTMLCollection) {
                ...
                (!f || Q(50) && -1 !== wq.indexOf(e.tagName)) && a.push(e)
            }
        }
        return {
            elements: a,
    ...
    ;var Zq = !1;
    function $q() {
        if (Yq("join-ad-interest-group") && Ca(Ec.joinAdInterestGroup))
            return !0;
        Zq || (Bl(''),
        Zq = !0);
        return Yq("join-ad-interest-group") && Ca(Ec.joinAdInterestGroup)
    }
    function ar(a, b) {
        var c = void 0;
        try {
    ...
    var bs = {
        H: {
            ...
            Ki: "event_execute_end",
            Ji: "event_evaluation_end",
            Mg: "event_evaluation_start",
            Li: "event_setup_end",
            de: "event_setup_start",
            Mi: "ga4_conversion_hit",
            je: "page_load",
            Ym: "pageview",
            qc: "snippet_load",
            Wi: "tag_callback_error",
            Xi: "tag_callback_failure",
            Yi: "tag_callback_success",
            Zi: "tag_execute_end",
    ...
    var Vs = function(a, b, c) {
        ...
        if (b) {
            ...
            if (!e)
                return !1;
            var g = hn(decodeURIComponent(f.replace(/\+/g, " ")) + ":" + decodeURIComponent(e.replace(/\+/g, " ")));
            if (!Us(g, b))
                return !1
        }
        d && 4 != d && (a = yl(a, "rfmt", d));
    ...
    ;var vt = new RegExp(/^(.*\.)?(google|youtube|blogger|withgoogle)(\.com?)?(\.[a-z]{2})?\.?$/)
      , wt = {
        cl: ["ecl"],
      ...
      , zt = "google customPixels customScripts html nonGooglePixels nonGoogleScripts nonGoogleIframes".split(" ")
      , Ct = function(a) {
        ...
        return function(g) {
            ...
            var x = !n || u;
            x || !(0 <= m.indexOf("sandboxedScripts")) || c && -1 !== c.indexOf("sandboxedScripts") || (x = Ka(e, zt));
            return f[k] = x
        }
    }
      , Bt = !1;
    Bt = !0;
    var At = function() {
        return vt.test(z.location && z.location.hostname)
    }
      , Dt = function() {
        hk && st(pk(), function(a) {
            var b = Af(a), c;
    ...
    ;var It = function(a, b, c, d, e) {
        if (!Ht() && !vk(a)) {
            var f = "?id=" + encodeURIComponent(a) + "&l=" + ni.da
              , g = 0 === a.indexOf("GTM-");
            g || (f += "&cx=c");
            Q(63) && (f += "&gtm=" + bn());
            var k = Ft();
      ...
      , Jt = function(a, b, c) {
        ...
        if (d)
            if (yk())
                ...
                var f = "/gtag/destination?id=" + encodeURIComponent(a) + "&l=" + ni.da + "&cx=c";
                Q(63) && (f += "&gtm=" + bn());
                Ft() && (f += "&sign=" + ni.vf);
                var g = wi || yi ? Et(b, f) : void 0;
                g || (g = fp("https://", "http://", ni.Ve + f));
                var k = a;
                c.siloed && (xk({
                    ctid: k,
                    isDestination: !0
    ...
    function Mt(a) {
        var b = "";
        Kt && (b = "&dl=" + encodeURIComponent(Kt));
        0 < Lt.length && (b += "&tdp=" + Lt.join("."));
        a.Xb && (Kt = "",
        Lt.length = 0,
        b && a.Cj());
        return b
    ...
    ;var Pt = {
      ...
      , Qt = {}
      , Rt = Object.freeze((Qt[N.g.Ma] = !0,
    Qt))
      , St = 0 <= B.location.search.indexOf("?gtm_diagnostics=") || 0 <= B.location.search.indexOf("&gtm_diagnostics=")
      , Ut = function(a, b, c) {
        if (Ik && "config" === a && !(1 < cp(b).O.length)) {
            ...
            for (k in d) {
                var m = Tt(d[k], f);
                m.length && (St && console.log(m),
                g.push(k))
            }
            g.length && (g.length && Ik && Nt.push(b + "*" + g.join(".")),
            zb("TAGGING", Pt[B.readyState] || 14));
            d[b] = f
        }
    };
    function Vt(a, b) {
    ...
    function Cu(a) {
        var b = a.eventId, c = a.Xb, d = Au[b] || {}, e = [], f;
        for (f in d)
    ...
    ;function Lu(a, b, c, d) {
        ...
        if (g && g.length) {
            ...
            f = Lu(k.index, {
                onSuccess: f,
                onFailure: 1 === k.jj ? b.terminate : f,
    ...
    function Mu(a, b, c, d) {
        function e() {
            if (f[Pe.Ak])
                ...
                var A = fu(c.Qb, String(f[Pe.xa]), Number(f[Pe.oe]), w[Pe.Bk])
                  , C = !1;
            ...
            if (a[d]) {
                ...
                try {
                    ...
                    if (g) {
                        ...
                        c.push({
                            Ej: d,
                            xj: (m ? m.priorityOverride || 0 : 0) || qt(e[Pe.xa], 1) || 0,
                            execute: g
                        })
                    } else
                        iv(d, b),
    ...
    var mv = function(a, b) {
        ...
        var c = a["gtm.triggers"] && String(a["gtm.triggers"])
          , d = lv.C(a.event, c ? String(c).split(",") : []);
        if (!d.length)
            return !1;
    ...
    var Rv = function(a) {
        ...
        var g = a.eventCallback
          ...
          , m = {
            ...
            cachedModelValues: pv(),
            checkPixieIncompatibility: qv(b),
            Qb: new eu(function() {
                if (Q(27)) {}
        ...
        Q(53) && (m.reportMacroDiscrepancy = Bu);
        Q(27) && Ns(m.id, m.name);
        var n = Nf(m);
        Q(27) && Os(m.id, m.name);
        f && (n = Kv(n));
    ...
    function Kv(a) {
        for (var b = [], c = 0; c < a.length; c++)
            if (a[c]) {
                var d = String(rf[c][Pe.xa]);
                if (qi[d] || void 0 !== rf[c][Pe.Ek] || Hi[d] || qt(d, 2))
                    b[c] = !0
            }
        return b
    }
    function Qv(a, b) {
        if (!b)
            return b;
        for (var c = 0; c < a.length; c++)
            if (a[c] && rf[c] && !ri[String(rf[c][Pe.xa])])
                return !0;
        return !1
    }
    var Sv = {};
    function Tv(a, b, c) {
        Ik && void 0 !== a && (Sv[a] = Sv[a] || [],
        Sv[a].push(c + b),
        Sk(a))
    }
    function Uv(a) {
        ...
        if (d.h) {
            ...
            if (f) {
                ...
                var r = d.h.prefix
                  ...
                  , u = ll(kl(jl(il(hl(fl(el(gl(dl(cl(bl(new al(d.messageContext.eventId,d.messageContext.priorityId), g), k), m), n), p), q), d.messageContext.eventMetadata), function() {
                    if (t) {
                        var v = t;
                        t = void 0;
                        v("2");
                ...
                try {
                    Tv(d.messageContext.eventId, r, "1"),
                    Ut(d.type, d.h.id, u),
                    f(d.h.id, b, d.C, u)
                } catch (v) {
    ...
    dw.prototype.push = function(a, b, c, d) {
        void 0 !== c && (1 === Zv(this, c).status && (Zv(this, c).status = 2,
        this.push("require", [{}], c, {})),
        Zv(this, c).C && (d.deferrable = !1));
    ...
    dw.prototype.flush = function(a) {
        for (var b = this, c = [], d = !1, e = {}; this.h.length; ) {
            ...
            if (f.messageContext.deferrable)
                !g || Zv(this, g).C ? (f.messageContext.deferrable = !1,
                ...
                case "config":
                    ...
                    var n = g.ba === g.id;
                    m || (n ? k.F = {} : k.K[g.id] = {});
                    k.C && m || ew(this, N.g.na, e.Rb, f);
                    k.C = !0;
                    n ? mb(e.Rb, k.F) : (mb(e.Rb, k.K[g.id]),
                    M(70));
                    d = !0;
                    break;
                case "event":
    ...
    var fw = function(a, b) {
        if ("require" !== b.type)
            if (b.h)
                for (var c = Zv(a, b.h).B[b.type] || [], d = 0; d < c.length; d++)
                    c[d]();
            else
                for (var e in a.B)
    ...
    var tw = {
        config: function(a, b) {
            ...
            if (!(2 > a.length) && h(a[1])) {
                ...
                if (f) {
                    ...
                    r && (g = r.Zl,
                    k = r.Tl);
                    yu(d.eventId, "gtag.config");
                    var t = f.ba
                      , u = f.id !== t;
                    if (u ? -1 === mk().indexOf(t) : -1 === kk().indexOf(t)) {
                        ...
                        b.eventMetadata = ha;
                        delete e[N.g.Rc];
                        for (var Z = u ? [f.id] : mk(), R = 0; R < Z.length; R++) {
                            var ia = e
                              , ma = mb(b)
                              , ea = cp(Z[R], ma.isGtmEvent);
                            ea && Vv.push("config", [ia], ea, ma)
                        }
                    }
                }
            }
        ...
        consent: function(a, b) {
            if (3 === a.length) {
                ...
                var c = ow(a, b)
                  , d = a[1];
                "default" === d ? Tj(a[2]) : "update" === d ? Uj(a[2], c) : "declare" === d ? b.fromContainerExecution && Sj(a[2]) : Q(108) && "core_platform_services" === d && Vj(a[2])
            }
        },
        event: function(a, b) {
            var c = a[1];
            if (!(2 > a.length) && h(c)) {
                ...
                if (h(r) || Ea(r)) {
                    ...
                    var u = iw(t, b.isGtmEvent)
                      ...
                      , w = u.Wl;
                    if (w.length)
                        for (var x = sw(q), y = 0; y < w.length; y++) {
                ...
                if (C) {
                    ...
                    for (var D = [], G = 0; G < C.length; G++) {
                        var F = C[G]
                          , I = mb(b);
                        if (-1 !== lw.indexOf(rk(F.prefix))) {
                            var O = mb(d)
                              , T = I.eventMetadata || {};
                            T.hasOwnProperty("is_external_event") || (T.is_external_event = !I.fromContainerExecution);
                            I.eventMetadata = T;
                            delete O[N.g.Rc];
                            Xv(c, O, F.id, I)
                        }
        ...
        get: function(a, b) {
            M(53);
            if (4 === a.length && h(a[1]) && h(a[2]) && Ca(a[3])) {
                ...
                if (c) {
                    ...
                    else if (-1 !== lw.indexOf(rk(c.prefix))) {
                        ow(a, b);
                        var g = {};
                        Pj(mb((g[N.g.cb] = d,
                        g[N.g.tb] = e,
        ...
        for (var a = !1, b; !Xw && (b = dx()); ) {
            ...
            if (null == d)
                ...
                try {
                    ...
                    if ("number" === typeof u) {
                        for (var v = Tw[String(u)] || [], w = 0; w < v.length; w++)
                            Vw.push(fx(v[w]));
                        v.length && Vw.sort(Yw);
                        delete Tw[String(u)];
                        u > Sw && (Sw = u)
    ...
    var py = function(a, b, c) {
        ...
        return {
            createEvent: function(g, k, m) {
                var n = a()
                  , p = n.eh
                  , q = void 0 !== m ? Math.round(m) : void 0 !== k ? Math.round(n.eh * k) : Math.round(n.gj)
                  , r = void 0 !== k ? Math.round(100 * k) : 0 >= p ? 0 : Math.round(q / p * 100)
                  , t = B.hidden ? !1 : .5 <= dq(c);
                d();
                var u = void 0;
                void 0 !== b && (u = [b]);
                var v = Qx(c, "gtm.video", u);
    ...
    function bz(a, b) {
        function c(g) {
            var k = Bn(g)
              ...
              , n = zn(k, "host", !0)
              , p = zn(k, "port")
              , q = zn(k, "path").toLowerCase().replace(/\/$/, "");
    ...
    ;function ez() {
        var a = ["&cv=1", "&rv=" + ni.Rg, "&tc=" + rf.filter(function(b) {
            return b
        }).length];
    ...
    function hz() {
        ...
        return function(b, c, d) {
            ...
            Q(107) && e && e.cachedModelValues && (k.cachedModelValues = {
            ...
            var q = Le(a, k, [b, g]);
            a.h.h.F = void 0;
            q instanceof va && "return" === q.h && (q = q.B);
    ...
    pA.D = "internal.copyFromDataLayerCache";
    function qA(a) {
        var b;
        return b
    }
    ...
    function sA(a, b) {
        ...
        var d = od(b) || {}
          , e = od(a, this.h, 1).mj()
          , f = e.s;
        d.omitEventContext && (f = ll(new al(e.s.eventId,e.s.priorityId)));
    ...
    function xA(a) {
        if (!a)
            return {};
        var b = a.Zk;
        return cu(b.type, b.index, b.name)
    }
    function yA(a) {
        return a ? {
    ...
    var pB = function(a, b) {
        ...
        if (0 < d) {
            var f = An(Bn(c))
              , g = An(Bn(z.location.href));
            return f !== g
        }
        return !0
    }
      , qB = function(a, b) {
        for (var c = zn(Bn((b.attributes && b.attributes.formaction ? b.formAction : "") || b.action || Wc(b, "href") || b.src || b.code || b.codebase || ""), "host"), d = 0; d < a.length; d++)
            try {
      ...
      , rB = function() {
        var a = 0
          , b = function(c) {
            var d = c.target;
            if (d && 3 !== c.which && !(c.nh || c.timeStamp && c.timeStamp === a)) {
                a = c.timeStamp;
                d = Uc(d, ["a", "area"], 100);
                if (!d)
                    return c.returnValue;
                var e = c.defaultPrevented || !1 === c.returnValue, f = Ux("aelc", e ? "nv.mwt" : "mwt", 0), g;
                g = e ? Ux("aelc", "nv.ids", []) : Ux("aelc", "ids", []);
                ...
                if (k.length) {
                    var q = pB(c, d)
                      , r = Qx(d, "gtm.linkClick", k);
                    r["gtm.elementText"] = Sc(d);
                    r["gtm.willOpenInNewWindow"] = !q;
                    if (q && !e && f && d.href) {
                        var t = !!Ga(String(Wc(d, "rel") || "").split(" "), function(x) {
      ...
      , zB = function() {
        ...
        var c = 0
          ...
          , e = function() {
            ...
            xB(),
            Ux("sdl", "init", !1) && !yB() && (Qc(z, "scroll", f),
            Qc(z, "resize", f),
            Sx("sdl", "init", !1)));
            d = !1
        }
    ...
    function DB(a, b) {
        ...
        Ux("sdl", "init", !1) ? Ux("sdl", "pending", !1) || E(function() {
            return xB()
        }) : (Sx("sdl", "init", !0),
        Sx("sdl", "pending", !0),
        E(function() {
    ...
    var nc = ca(["data-gtm-yt-inspected-"]), GB = ["www.youtube.com", "www.youtube-nocookie.com"], HB, IB = !1;
    var JB = function(a, b, c) {
      ...
      , MB = function(a, b) {
        ...
        function f(G) {
            ...
            case 1:
                ...
                y = a.getPlaybackRate();
                b.Xg ? Zw(t.createEvent("start")) : t.bd();
                u = JB(b.Dh, b.Ch, a.getDuration());
                return g(G);
            default:
                return f
            }
        ...
        function k(G) {
            ...
            case 3:
                ...
                F = 1 < Math.abs((Ra().getTime() - C) / 1E3 * y - I) ? "seek" : F || "buffering";
                a.getCurrentTime() && (b.Wg ? Zw(t.createEvent(F)) : t.bd());
                q();
                return m;
            case -1:
                return e(G);
        ...
        function n() {
            ...
            b.Vg && Zw(t.createEvent("complete", 1));
            return e(-1)
        }
        function p() {}
        function q() {
        ...
        function r() {
            if (u.length && 0 !== y) {
                ...
                c = function() {
                    ...
                    Zw(t.createEvent("progress", F.Oe, F.Qe)));
                    r()
                }
                ;
      ...
      , NB = function(a, b) {
        if (!a.getAttribute("data-gtm-yt-inspected-" + b.jb) && (mc(a, "data-gtm-yt-inspected-" + b.jb),
        PB(a, b.ye))) {
            a.id || (a.id = QB());
            var c = z.YT
              , d = c.get(a.id);
    ...
    function SB(a, b) {
        ...
        var d = !!a.get("captureStart")
          ...
          , g = LB(od(a.get("progressThresholdsPercent")))
          , k = KB(od(a.get("progressThresholdsTimeInSeconds")))
    ...
    function wD() {
        ...
        a.set("containerId", 'G-6L3G54N42E'),
        a.set("version", '1'),
        a.set("environmentName", ''),
        a.set("debugMode", $f),
        a.set("previewMode", bg),
        a.set("environmentMode", ag),
        Q(83) && a.set("firstPartyServing", wi || yi),
        Q(84) && a.set("containerUrl", Fc),
        a.Bb();
        return a
    }
    ...
    HD.enableDecodeUri = Q(88);
    HD.enableDeferAllEnhancedMeasurement = Q(58);
    HD.enableDirectTagLoadingInGoogleTag = Q(106);
    ...
    HD.enableGetElementInnerText = Q(73);
    HD.enableRemoteDomainListSettingsInPixie = Q(89);
    HD.enableUrlDecodeEventUsage = Q(75);
    HD.pixieSetCorePlatformServices = Q(44);
    HD.useEnableAutoEventOnFormApis = Q(37);
    HD.autoPiiEligible = oj();
    function ID() {
        return nd(HD)
    }
    ...
    function LD(a, b) {
        ...
        var d = zn(Bn(z.location.href), "query")
          , e = wn(d, a, b);
        c = nd(e, this.h);
        return c
    }
    ...
    var SD = function(a) {
      ...
      , TD = function(a) {
        if (a.metadata.is_merchant_center || !Gt(a.s))
            return !1;
        if (!V(a.s, N.g.Pd)) {
            var b = V(a.s, N.g.Id);
            return !0 === b || "true" === b
    ...
    var XD = !1
      , YD = function(a) {
        var b = a.eventName === N.g.hc && Jj() && TD(a)
    ...
    var eE = function(a, b, c) {
      ...
      , hE = function(a, b) {
        ...
        var d = b.metadata.cookie_options
          , e = d.prefix + "_ga"
          , f = En(d, void 0, void 0, N.g.R);
        if (!1 === V(b.s, N.g.rb) && fE(b) === a)
            c = !0;
        else {
            var g = Ym(a, gE[0], d.domain, d.path);
            c = 1 !== Hm(e, g, f)
        }
        return c
    }
      , fE = function(a) {
        var b = a.metadata.cookie_options
          , c = b.prefix + "_ga"
          , d = Xm(c, b.domain, b.path, gE, N.g.R);
        if (!d) {
            var e = String(V(a.s, N.g.jc, ""));
            e && e != c && (d = Xm(e, b.domain, b.path, gE, N.g.R))
        }
        return d
    }
      , gE = ["GA1"]
      , iE = function(a, b) {
        var c = a.h[N.g.Za];
        if (V(a.s, N.g.vb) && V(a.s, N.g.Jb) || b && c === b)
            return c;
        if (c) {
            c = "" + c;
            if (!hE(c, a))
    ...
    var lE = function(a, b, c) {
        ...
        g.Bc = d.Bc + 1;
        var k;
        return null != (k = kE(g.sessionId, g.Bc, g.nd, g.Le, g.th, g.xc, g.ue)) ? k : b
    }
      , oE = function(a, b) {
        var c = b.metadata.cookie_options
          , d = mE(b, c)
          , e = Ym(a, nE[0], c.domain, c.path)
          , f = {
            Eb: N.g.R,
            domain: c.domain,
            path: c.path,
            expires: c.Sb ? new Date(Sa() + 1E3 * c.Sb) : void 0,
            flags: c.flags
        };
        Hm(d, void 0, f);
        return 1 !== Hm(d, e, f)
      ...
      , pE = function(a) {
        var b = a.metadata.cookie_options
          , c = mE(a, b)
          , d = Xm(c, b.domain, b.path, nE, N.g.R);
        if (!d)
            return d;
        var e = ym(c, void 0, void 0, N.g.R);
        if (d && 1 < e.length) {
            M(114);
    ...
    var rE = function(a) {
      ...
      , vE = function(a) {
        var b = rE(a) || {}
          ...
          , e = mE(a, c)
          , f = {};
        fo(b[N.g.nc], !!b[N.g.T]) && (f = tE(a, d, e),
        ...
        b[N.g.T] && bo(function() {
            ...
            var m = pE(a);
            m && (g[e] = m);
            var n = ym("FPLC", void 0, void 0, N.g.R);
      ...
      , xE = function(a) {
        ...
        return !S("analytics_storage") && wE() ? sE(c, d) : {}
    }
      , wE = function() {
        var a = yn(z.location, "host")
          , b = yn(Bn(B.referrer), "host");
    ...
    var AE = function(a, b) {
        ...
        Q(91) && (im(b.s) && (Q(78) || yC()) ? Q(49) && (a.npa = "0") : a.npa = "1")
    }
      , DE = function(a) {
        if (a.metadata.is_merchant_center)
            return "https://www.merchant-center-analytics.goog/mc/collect";
        var b = Et(Gt(a.s), "/g/collect");
        if (b)
            return b;
        var c = wp(a, N.g.eb, V(a.s, N.g.eb));
        c = c || SD(a);
        var d = V(a.s, N.g.qb);
        return c && !mj() && !1 !== d && xC() && S(N.g.I) && S(N.g.R) ? BE() : CE()
    }
      , EE = !1;
    EE = !0;
    var FE = {};
    ...
    JE))
      ...
      , LE = function(a, b, c) {
        ...
        AE(d, a);
        Q(47) && (rm() && (d.dma_cps = om()),
        d.dma = qm());
        Q(78) && Ll(Ul()) && (d.tcfd = sm());
        var g = a.h[N.g.ub];
        g && (d.gdid = g);
        ...
        l(a.h, function(t, u) {
            if (void 0 !== u && !Zh.hasOwnProperty(t)) {
                null === u && (u = "");
                var v;
                t !== N.g.Qc ? v = !1 : a.metadata.euid_mode_enabled || q ? (d.ecid = u,
                v = !0) : v = void 0;
                if (!v && t !== N.g.cf) {
                    var w = u;
                    !0 === u && (w = "1");
                    ...
                    if (FE[t])
                        ...
                        var y;
                        IE[t] ? y = !0 : t !== N.g.Hc ? y = !1 : ("object" !== typeof u && p(t, u),
                        y = !0);
                        y || p(t, u)
                    }
                }
        ...
        var r = a.h[N.g.Na] || {};
        Q(91) || (im(a.s) && (Q(78) || yC()) ? Q(49) && (r._npa = "0") : r._npa = "1");
        Q(12) && !1 === V(a.s, N.g.qb) && (d.ngs = "1");
        l(r, function(t, u) {
            void 0 !== u && ((null === u && (u = ""),
            t !== N.g.za || f.uid) ? b[t] !== u && (e[(Da(u) ? "upn." : "up.") + String(t)] = String(u),
    ...
    var SE = function(a, b, c, d) {
      ...
      , TE = function(a, b) {
        ...
        if (d || e) {
            ...
            Qj("https://stats.g.doubleclick.net/g/collect?v=2&" + p.join("&")));
            if (e) {
                p.push("z=" + Ha());
                if (!m) {
    ...
    UE.prototype.flush = function() {
        if (this.h.events.length) {
            ...
            SE(this.h.h, a.zh, a.body, this.h.B);
            this.h = new ig;
    ...
    var YE = function(a, b, c) {
      ...
      , ZE = function(a) {
        if (TD(a)) {
            if (Q(105)) {
                var b = wp(a, "ccd_add_1p_data", !1) ? 1 : 0;
                WD(a, "ude", b)
            }
            var c = function(e) {
                var f = YE(N.g.wa, e);
              ...
              , d = V(a.s, N.g.wa);
            void 0 !== d ? (c(d),
            Q(99) && (a.h[N.g.be] = "c")) : c(a.metadata.user_data);
    ...
    var $E = window
      ...
      , bF = function(a) {
        ...
        for (var d = um("AMP_TOKEN", String(aF.cookie), !0), e = 0; e < d.length; e++)
            if ("$OPT_OUT" == d[e])
                return !0;
    ...
    aa.hm = function(a, b, c) {
        ...
        if (e)
            if (c.eventMetadata.is_external_event && "_" === a.charAt(0))
                ...
                var g = [N.g.R];
                (wp(f, N.g.eb, V(f.s, N.g.eb)) || TD(f)) && g.push(N.g.I);
                Q(67) && TD(f) && g.push(N.g.M);
                var k = function() {
                    Zj(function() {
                        d.im(f)
                    }, g)
    ...
    aa.im = function(a) {
        ...
        try {
            ...
            if (0 <= rn.Xk.replace(/\s+/g, "").split(",").indexOf(a.eventName))
                a.isAborted = !0;
            else {
                var f = VD(a);
            ...
            var m = {
                ...
                Sb: Number(V(a.s, N.g.Ha, 63072E3))
            };
            a.metadata.cookie_options = m;
            kF(a);
            this.xk(a);
            this.F.Em(a);
            a.metadata.is_merchant_center ? a.metadata.euid_mode_enabled = !1 : V(a.s, N.g.kf) ? a.metadata.euid_mode_enabled = !1 : wp(a, "ccd_add_1p_data", !1) && (a.metadata.euid_mode_enabled = !0);
            ...
            var q = this.yj, r;
            V(a.s, N.g.Ab) && (S(N.g.R) || V(a.s, N.g.Za) || (a.h[N.g.Qi] = !0));
            var t;
            var u;
            u = void 0 === u ? 3 : u;
            var v = z.location.href;
            if (v) {
                var w = Bn(v).search.replace("?", "")
                  , x = wn(w, "_gl", !1, !0) || "";
                t = x ? void 0 !== Wn(x, u) : !1
            } else
                t = !1;
            ...
            C && (this.K = !0);
            a.eventName == N.g.na && (V(a.s, N.g.Ma, !0) ? (a.s.h[N.g.aa] && (a.s.C[N.g.aa] = a.s.h[N.g.aa],
            a.s.h[N.g.aa] = void 0,
            a.h[N.g.aa] = void 0),
            a.eventName = N.g.hc) : a.isAborted = !0);
            C && !a.isAborted && 0 < this.Og++ && aE(17);
            var D = ab(Zk(a.s, N.g.aa, 1), ".");
            D && (a.h[N.g.ub] = D);
            var G = ab(Zk(a.s, N.g.aa, 2), ".");
            G && (a.h[N.g.sb] = G);
            var F = this.C
              , I = this.F
              , O = !this.ee
            ...
            if (V(a.s, N.g.vb) && V(a.s, N.g.Jb))
                ...
                if (!U) {
                    var Z = S(N.g.R)
                      , R = bE();
                    U = !R.from_cookie || Z ? R.vid : void 0;
                    ha = 6
                }
                U ? U = "" + U : (U = Um(),
                ha = 7,
            ...
            ea = Math.min(475, ea);
            ea = Math.max(5, ea);
            var Ia = Ma(V(a.s, N.g.nf, 1E4))
              , ua = jE(ma);
            a.metadata.is_first_visit = !1;
            a.metadata.is_session_start = !1;
            a.metadata.join_timer_sec = 0;
            ua && ua.th && (a.metadata.join_timer_sec = Math.max(0, ua.th - Math.max(0, ia - ua.Le)));
            var Fa = !1;
            ...
            if (Fa)
                ...
                I.yl(a);
            else if (I.ol() > Ia || a.eventName == N.g.hc)
                ua.nd = !0;
            a.metadata.euid_mode_enabled ? V(a.s, N.g.za) ? ua.xc = !0 : (ua.xc && (ua.ue = void 0),
            ua.xc = !1) : ua.xc = !1;
            var Pa = ua.ue
              , jb = Q(105) && TD(a);
            if (a.metadata.euid_mode_enabled || jb) {
                ...
                if (void 0 === Mg || Ld <= Mg)
                    a.h[N.g.Qc] = Db.toString(),
                    a.metadata.enhanced_client_id_source = Ld
            }
            O ? (a.copyToHitData(N.g.zb, ua.sessionId),
            a.copyToHitData(N.g.Rd, ua.Bc),
            a.copyToHitData(N.g.Qd, ua.nd ? 1 : 0)) : (a.h[N.g.zb] = ua.sessionId,
            a.h[N.g.Rd] = ua.Bc,
            a.h[N.g.Qd] = ua.nd ? 1 : 0);
            a.metadata[N.g.cf] = ua.xc ? 1 : 0;
            lF(a);
            if (!V(a.s, N.g.Jb) || !V(a.s, N.g.vb)) {
                var rv = ""
                  , Ng = B.location;
                if (Ng) {
                    var Ni = Ng.pathname || "";
                    "/" != Ni.charAt(0) && (Ni = "/" + Ni);
                    rv = Ng.protocol + "//" + Ng.hostname + Ni + Ng.search
                }
                a.copyToHitData(N.g.ra, rv, decodeURI);
                var nH = a.copyToHitData, oH = N.g.Ea, Oi;
                a: {
                    var sv = ym("_opt_expid", void 0, void 0, N.g.R)[0];
                    if (sv) {
                        var tv = decodeURIComponent(sv).split("$");
                        if (3 === tv.length) {
                            Oi = tv[2];
                            break a
                        }
                    ...
                    if (void 0 !== oi.ga4_referrer_override)
                        ...
                        var uv = Ui("gtm.gtagReferrer." + a.target.ba)
                          , pH = B.referrer;
                        Oi = uv ? "" + uv : pH
                    }
                }
                ...
                var vv = aq();
                a.copyToHitData(N.g.yb, vv.width + "x" + vv.height);
                Q(33) && a.copyToHitData(N.g.Uc, void 0, decodeURIComponent);
                Q(81) && $p() && a.copyToHitData(N.g.hf, "1")
            }
            a.metadata.create_dc_join = !1;
            a.metadata.create_google_join = !1;
            if (!(Q(57) && TD(a) || a.metadata.is_merchant_center || !1 === V(a.s, N.g.qb)) && xC() && S(N.g.I)) {
                var Pi = wp(a, N.g.eb, V(a.s, N.g.eb));
                Pi = Pi || SD(a);
                (a.metadata.is_session_start || V(a.s, N.g.ef)) && (a.metadata.create_dc_join = !!Pi);
                var wv;
                wv = a.metadata.join_timer_sec;
                Pi && 0 === (wv || 0) && (a.metadata.join_timer_sec = 60,
            ...
            for (var xv = V(a.s, N.g.ff) || [], Jm = 0; Jm < xv.length; Jm++) {
                var yv = xv[Jm];
                if (yv.rule_result) {
                    a.copyToHitData(N.g.qf, yv.traffic_type);
                    aE(3);
                    break
                }
            }
            if (!a.metadata.is_merchant_center && Gt(a.s)) {
                var zv = rE(a) || {}
                  , rH = (fo(zv[N.g.nc], !!zv[N.g.T]) ? Vn(!0)._fplc : void 0) || (0 < ym("FPLC", void 0, void 0, N.g.R).length ? void 0 : "0");
                a.h._fplc = rH
            }
            if (void 0 !== V(a.s, N.g.Sc))
                a.copyToHitData(N.g.Sc);
            else {
                var Av = V(a.s, N.g.Od), Km, Qi;
                a: {
                    if (uE) {
                        var Lm = rE(a) || {};
                        if (Lm && Lm[N.g.T])
                            for (var Bv = zn(Bn(a.h[N.g.Ea]), "host", !0), Ri = Lm[N.g.T], Og = 0; Og < Ri.length; Og++)
                                if (Ri[Og]instanceof RegExp) {
                                    if (Ri[Og].test(Bv)) {
                                        Qi = !0;
                                        break a
                                    }
                                } else if (0 <= Bv.indexOf(Ri[Og])) {
                                    Qi = !0;
                                    break a
                                }
                    }
                ...
                if (!(Km = Qi)) {
                    ...
                    if (Si = Av)
                        a: {
                            for (var Cv = Av.include_conditions || [], sH = zn(Bn(a.h[N.g.Ea]), "host", !0), Mm = 0; Mm < Cv.length; Mm++)
                                if (Cv[Mm].test(sH)) {
                                    Si = !0;
                                    break a
                                }
            ...
            TD(a) && (Jj() || Q(41)) && ((Kj() || Q(45)) && WD(a, "gcd", nm(a.s)),
            V(a.s, N.g.oa) && WD(a, "adr", 1));
            if (TD(a)) {
                var Fv = pr();
                Fv && WD(a, "us_privacy", Fv);
                var Gv = bm();
                Gv && WD(a, "gdpr", Gv);
                var Hv = am();
                Hv && WD(a, "gdpr_consent", Hv)
            }
            Q(70) && TD(a) && (a.h[N.g.Ii] = lj() || kj());
            if (TD(a) && Q(80)) {
                var Iv = Di;
                Iv && WD(a, "tft", Number(Iv))
            }
            Q(93) && TD(a) && (a.metadata.speculative && WD(a, "sp", 1),
            ...
            a: if (Q(7))
                if (!nn(z))
                    ...
                    if (Jv) {
                        if (Q(22)) {
                            if (V(a.s, N.g.Wc) && !TD(a))
                                break a
                        } else if (V(a.s, N.g.Wc))
                            break a;
                        tn(Jv, a)
                    } else
                        M(86)
            ...
            if (Q(32)) {
                var Nm = Yq(Xq());
                Nm || nF || (nF = !0,
                Bl(''),
                Nm = Yq(Xq()));
                Nm && (a.h[N.g.Hb] = "1")
            }
            ...
            zp(a);
            ZE(a);
            Q(93) && TD(a) && (a.metadata.speculative = !1);
            var Nv = V(a.s, N.g.vb);
            Nv && aE(12);
            a.metadata.em_event && aE(14);
            var Pg = qk(wk());
            (Nv || Ak(Pg) || Pg && Pg.parent && Pg.context && 5 === Pg.context.source) && aE(19);
            ...
            var uH = this.yj, Pv, vH = this.h, Qm;
            a: {
                var Rm = qE(a);
                if (Rm) {
                    if (oE(Rm, a)) {
            ...
            if (TD(a)) {
                ...
                if ("page_view" === a.eventName || xH)
                    fF(this, a, N.g.I),
                    Q(67) && fF(this, a, N.g.M)
            }
            this.F.Fh();
            this.fe = oF(a, this.fe);
            a.copyToHitData(N.g.rg);
            V(a.s, N.g.Wc) && (a.h[N.g.Wc] = !0,
            TD(a) || eF(a, N.g.yb));
            if (a.isAborted) {
                a.s.onFailure();
                Ab();
    ...
    ;
    aa.xk = function(a) {
        a.eventName !== N.g.Ja && this.F.wk(a)
    }
    ;
    var kF = function(a) {
        function b(c, d) {
    ...
    function tF(a, b, c) {
        ...
        d.km(function() {
            XD = !0;
            Vv.flush();
            1E3 <= d.Ff() && Ec.sendBeacon && Xv(N.g.vd, {}, a.id, f);
            b.flush();
            d.zj(function() {
                XD = !1;
                d.zj()
    ...
    function() {
        (function(a) {
            ...
            var f = Uu(String(b.streamId), d, c);
            Xu(f, e.eventId, e);
            a.vtp_gtmOnSuccess()
        })
    }();
    ...
    function aI() {
        oi[ok()] = oi[ok()] || $H;
        uk();
        yk() || l(zk(), function(a, b) {
            Jt(a, b.transportUrl, b.context);
            M(92)
        });
        Va(Gi, Y.m);
        Q(86) && qk(wk());
    ...
    (function(a) {
        ...
        if (Ai)
            ...
            var f = function(u) {
                ...
                Lc("https://" + ni.Ve + "/debug/bootstrap?id=" + Sf.ctid + "&src=" + w + "&cond=" + u + "&gtm=" + bn()));
                var y = {
              ...
              , k = void 0
              , m = void 0
              , n = zn(z.location, "query", !1, void 0, "gtm_debug");
            jx(n) && (k = g.uk);
            if (!k && B.referrer) {
                var p = Bn(B.referrer);
                "tagassistant.google.com" === yn(p, "host") && (k = g.Fk)
            }
            if (!k) {
        ...
        try {
            ...
            if (dk().canonical[a]) {
                var b = oi.zones;
                b && b.unregisterChild(kk());
            } else {
                (Q(7) || Q(8) || Q(20) || Q(17)) && qn();
                Dt();
                ...
                for (var n = c.rules || [], p = 0; p < n.length; p++) {
                    for (var q = n[p], r = {}, t = 0; t < q.length; t++) {
                        ...
                        mf(5) || mf(7) ? ("if" !== u && "unless" !== u || xf(r[u]),
                        zb("TAGGING", 22)) : mf(6) && zb("TAGGING", 23)
                    }
                    pf.push(r)
                }
                tf = Y;
                ...
                a: {
                    ...
                    for (var F = [], I = 0; I < y.length; I++) {
                        ...
                        A && A[I] && A[I].length && Hf(O, A[I]);
                        try {
                            iz.execute(O),
                            Q(53) && Ik && 50 === O[0] && F.push(O[1])
                        } catch (Mg) {}
                    }
                    Q(53) && (zf = F)
                }
                if (void 0 !== v)
                    for (var T = ["sandboxedScripts"], U = 0; U < v.length; U++) {
                ...
                aI();
                if (Q(41) && !Ai) {
                    for (var R = jj["7"], ia = R ? R.split("|") : [], ma = {}, ea = 0; ea < ia.length; ea++)
                        ma[ia[ea]] = !0;
                    for (var Ia = 0; Ia < Rj.length; Ia++) {
                        var ua = Rj[Ia]
                ...
                if ("interactive" == B.readyState && !B.createEventObject || "complete" == B.readyState)
                    ...
                    Pc(B, "DOMContentLoaded", Zt);
                    Pc(B, "readystatechange", Zt);
                ...
                xw = !1;
                "complete" === B.readyState ? zw() : Pc(z, "load", zw);
                Ik && (Dk(Vk),
                z.setInterval(Uk, 864E5));
                Dk(ez);
                Dk(zu);
                Dk(cs);
                Dk(Uv);
